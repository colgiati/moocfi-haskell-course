...
oddFactorialHelper 1 t = t
oddFactorialHelper k t = oddFactorialHelper (k - 2) (k * t)
oddFactorial k
    | even k = oddFactorialHelper (k - 1) 1
    | otherwise = oddFactorialHelper k 1
...
countdown = countdownHelper "Ready! "

countdownHelper :: String -> Integer -> String
countdownHelper s 0 = s ++ "Liftoff!"
...
smallestDivisor = smallestDivisorHelper 2

smallestDivisorHelper :: Integer -> Integer -> Integer
smallestDivisorHelper k x
    | mod x k == 0 = k
    | otherwise = smallestDivisorHelper (k + 1) x
